...
export const CATEGORY_META: Record<ItemCategory, CategoryMeta> = {
  restaurant: {
    ...
    titleHint: "Aparece como titulo de la tarjeta y en el detalle del restaurante.",
    excerptLabel: "Descripcion corta",
    excerptHint: "2-3 lineas que aparecen en la tarjeta de /restaurantes. Ej: Cocina japonesa de autor en el corazon de la Zona G.",
    ...
    guide: [
      "FOTO: Sube una foto horizontal de alta calidad (minimo 1200x800 px). Evita logos.",
      "TEXTO: Escribe una descripcion de 2-3 lineas que evoque el ambiente y la cocina.",
      "UBICACION: Confirma la ubicacion. Formato: Ciudad - Barrio (ej: Bogota - Zona G).",
  ...
  job: {
    ...
    titleHint: "Ej: Jefe de cocina / Bartender - Turno noche. Aparece como titulo en la lista.",
    excerptLabel: "Descripcion del cargo",
    excerptHint: "Resumen de 2-3 lineas: responsabilidades principales y perfil buscado. Aparece en la tarjeta de /empleos.",
    locationLabel: "Sede o modalidad",
    locationHint: "Ej: Bogota - Zona T / Remoto. Aparece junto al titulo del puesto.",
    ...
    guide: [
      ...
      "DESCRIPCION: Resume las 3-5 responsabilidades principales del cargo.",
  ...
  service: {
    ...
    titleHint: "Aparece como titulo de la tarjeta en /servicios.",
    excerptLabel: "Descripcion corta",
    excerptHint: "1-2 lineas que explican que hace este servicio. Aparece en la tarjeta.",
  ...
  event: {
    ...
    excerptLabel: "Descripcion del evento",
    excerptHint: "Que es, cuando y por que asistir. 2-3 lineas. Aparece en la tarjeta.",
    locationLabel: "Lugar",
    ...
    guide: [
      ...
      "DESCRIPCION: Explica que vivira el asistente en 2-3 lineas.",
  ...
  app: {
    ...
    excerptLabel: "Descripcion corta",
    excerptHint: "1-2 lineas que explican para que es la app.",
